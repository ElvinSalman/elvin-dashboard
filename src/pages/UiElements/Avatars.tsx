...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Admin Panel - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Admin Panel - React.js Tailwind CSS Admin Dashboard Template"
      />
