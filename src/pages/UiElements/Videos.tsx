...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Admin Panel - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Admin Panel - React.js Tailwind CSS Admin Dashboard Template"
      />
